import { ImagesSE03Max, SE03Max } from "../../constants";
            ...
            <table className="shadow-xl">
              <thead>
                <tr>
                  ...
                  <th className="bg-n-5/80 dark:bg-n-8/70">
                    <h2 className="text-lg lg:text-2xl">Rhyno SE03 Max</h2>
                  </th>
                </tr>
              </thead>
              <tbody>
                {SE03Max.map((specification, index) => (
                  <>
