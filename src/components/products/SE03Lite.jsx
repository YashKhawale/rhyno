import { ImagesSE03Lite, SE03Lite } from "../../constants";
            ...
            <table className="shadow-xl">
              <thead>
                <tr>
                  ...
                  <th className="bg-n-5/80 dark:bg-n-8/70">
                    <h2 className="text-lg lg:text-2xl">Rhyno SE03 Lite</h2>
                  </th>
                </tr>
              </thead>
              <tbody>
                {SE03Lite.map((specification, index) => (
                  <>
